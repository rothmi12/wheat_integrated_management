...
AOVTukey_withinvar <- function(var, yr) {
  temp.df <- with(master.df, master.df[variety == as.character(var) &
                                       Year == as.character(yr),])
  mod <- lmer(Yield_kg_hect ~ management +
                                  (1|rep), data = temp.df)
...
AOVTukey_withinvar("Pro 380", "2016")
AOVTukey_withinvar("Pro 380", "2017")
AOVTukey_withinvar("Pro 380", "2018")
AOVTukey_withinvar("Pro 380", "2019")
